				...
				<nav aria-label="breadcrumb">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item ">
							<a class="link-website2"  href="#">Detail Positions</a>
						</li>
					</ul>
				</nav>
				<h1>Detail Positions</h1>
				<!-- Card-->
				<div class="card">
					<div class="card-body">
                        <div class="mb-3">
                            <label for="position" class="form-label"> Position </label>
                            <input type="text" class="form-control" id="position" placeholder="position" require value="<?php echo $position ?>" disabled>
                        </div>
					</div>
				</div>
			</main>	
