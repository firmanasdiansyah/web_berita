...
<body>
	<?php
		...
		if(isset($_POST['submit'])){
			...
			('$autho','$categor','$title','$content','$date','$picture','$positio')";
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 " >
				...
				<div class="card">
					<div class="card-body">
                        ...
                        <div class="mb-3">
                                <label for="title" class="form-label"> a </label>
                                <input type="text" class="form-control" id="a" name="a" placeholder="title" required>
                            </div>
							<div class="mb-3">
                                <label for="content" class="form-label"> ca </label>
								<textarea class="form-control" id="position" id="content" name="b" placeholder="content" required></textarea>
                    
                            </div>
                            <div class="mb-3">
                                <label for="title" class="form-label"> Title </label>
                                <input type="text" class="form-control" id="title" name="title" placeholder="c" required>
                            </div>
							<div class="mb-3">
                                <label for="content" class="form-label"> Content </label>
								<textarea class="form-control" id="position" id="content" name="d" placeholder="content" required></textarea>
							...
							<div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="picture" name="f"  required>
                            </div>
                            <div class="mb-3">
                                <label for="picture" class="form-label"> Pccre </label>
                                <input type="text" class="form-control" id="picture" name="g"  required>
                            </div>
