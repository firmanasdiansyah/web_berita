	...
	<div class="container-fluid">
		<div class="row">
			...
			<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
				...
				<div class="position-sticky"> 
                	<ul class="nav nav-pills flex-column mb-auto"> 
                		...
                		<li> 
                			<a href="/web_berita/admin/categories" class="nav-link active"> 
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 " >
				<nav aria-label="breadcrumb">
					<ul class="breadcrumb">
						<li class="breadcrumb-item active">
							<a class="link-website" href="#">Categories</a>
						</li>
						<li class="breadcrumb-item ">
							<a class="link-website2"  href="#">Daftar Categories</a>
						</li>
					</ul>
				</nav>
				...
				<div class="card">
					<div class="card-body">
						<a href="create.php" class="btn btn-block btn-dark mb-4 ">Tambah Categories</a>
