				...
				<nav aria-label="breadcrumb">
					<ul class="breadcrumb">
						<li class="breadcrumb-item active">
							<a class="link-website" href="/web_berita/admin/category">Categories</a>
						</li>
						<li class="breadcrumb-item ">
							<a class="link-website2"  href="#">Edit Categories</a>
						</li>
					</ul>
				</nav>
					...
					<div class="card-body">
						<form action="<?php echo $_SERVER['PHP_SELF']."?id=".$id ?>" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="category" name="category"  required value="<?php echo $category ?>">
                            </div>
