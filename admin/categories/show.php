				...
				<nav aria-label="breadcrumb">
					<ul class="breadcrumb">
						<li class="breadcrumb-item active">
							<a class="link-website" href="/web_berita/admin/categories">Categories</a>
						</li>
						<li class="breadcrumb-item ">
							<a class="link-website2"  href="#">Detail Categories</a>
						</li>
					</ul>
				</nav>
				...
				<div class="card">
					<div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Nama" require value="<?php echo $category ?>" disabled>
                        </div>
					</div>
				</div>
			</main>	
