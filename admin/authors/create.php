...
<body>
	<?php
		...
		if(isset($_POST['submit'])){
		    ...
		    include '../../connect.php';
            $sql = "INSERT INTO authors (name, phone) VALUES ('$name','$phone'); ";
				...
				<nav aria-label="breadcrumb">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item ">
							<a class="link-website2"  href="#">Create Authors</a>
						</li>
					</ul>
				</nav>
					...
					<div class="card-body">
						<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="08xxxxxx" required>
                            </div>
