	...
	<div class="container-fluid">
		<div class="row">
			...
			<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
				...
				<div class="position-sticky"> 
                	<ul class="nav nav-pills flex-column mb-auto"> 
                		...
                		<li> 
                			<a href="/web_berita/admin/authors" class="nav-link active"> 
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 " >
				<nav aria-label="breadcrumb">
					<ul class="breadcrumb">
						<li class="breadcrumb-item active">
							<a class="link-website" href="#">Authors</a>
						</li>
						<li class="breadcrumb-item ">
							<a class="link-website2"  href="#">Daftar Authors</a>
						</li>
					</ul>
				</nav>
				...
				<div class="card">
					<div class="card-body">
						<a href="create.php" class="btn btn-block btn-dark mb-4 ">Tambah Authors</a>
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th class="table-dark" scope="col">Telepon </th>
										...
										foreach ($datas as $key => $data){
											echo '
												<tr>
													...
													<td>'.$data['phone'].'</td>
													<td>
														<a href="show.php?id='.$data['id'].'" class="btn btn-block btn-dark  ">Lihat</a>
														<a href="edit.php?id='.$data['id'].'" class="btn btn-block btn-dark  ">Edit</a>
														<a onclick="return confirm(`Apakah Anda Yakin?`)" href="delete.php?id='.$data['id'].'" class="btn btn-block btn-dark  ">Hapus</a>
													</td>
												</tr>
											';
										}
