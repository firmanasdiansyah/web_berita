				...
				<nav aria-label="breadcrumb">
					<ul class="breadcrumb">
						<li class="breadcrumb-item active">
							<a class="link-website" href="/web_berita/admin/authors">Authors</a>
						</li>
						<li class="breadcrumb-item ">
							<a class="link-website2"  href="#">Detail Authors</a>
						</li>
					</ul>
				</nav>
				<h1>Detail Authors</h1>
				<!-- Card-->
				<div class="card">
					<div class="card-body">
                        <div class="mb-3">
                            <label for="name" class="form-label"> Nama </label>
                            <input type="text" class="form-control" id="name" placeholder="Nama" require value="<?php echo $name ?>" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="phone" class="form-label"> Phone </label>
                            <input type="text" class="form-control" id="phone" placeholder="Phone" require value="<?php echo $phone ?>" disabled>
                        </div>
					</div>
				</div>
			</main>	
